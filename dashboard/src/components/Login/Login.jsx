import { Stack, Text, Heading, FormLabel, FormControl, Input, Button, VStack, HStack } from '@chakra-ui/react'
...
const Login = () => {
    ...
    return (
        <Stack display="flex" direction="row" h="100vh" w="100vw" spacing={0}>
            <Stack bg="#50000E" color="white" alignItems={'center'} padding={32} textAlign='center' spacing={4}>
                <Heading fontWeight="bold">
                    Bem-vindo a nossa comunidade
                </Heading>
                <Text>
                    O E-menu fornece o melhor sistema necessário
