...
import {
    Box, FormControl, Input, FormLabel, HStack,
    Button,  Select, IconButton, VStack
}
                    ...
                    <VStack direction="row" h='100%'>
                        <HStack spacing="12">
                            <Box w="100%">
                                ...
                                <Input id="nome" placeholder="Insira o nome do produto" w="48vh" />
                            </Box>
                            <Box w="100%">
                        ...
                        <HStack spacing="12">
                            ...
                            <Box w="100%">   <FormLabel> Imagem do Produto </FormLabel>
                                <IconButton
                                    isRound={true}
                                    variant='solid'
                                    bg="#E4E4E7"
